...
public class IndexDaoTest {
  ...
  private final String RBSInstrumentJson = "{'instrumentId':'RBS001','name':'RBS','floatingCapitalization':100.5,'fixedCapitalization':100,'asOf':'2016-07-21'}";
  private final String ABNInstrumentJson = "{'instrumentId':'ABN001','name':'ABN','floatingCapitalization':200.5,'fixedCapitalization':200,'asOf':'2016-07-22'}";
  ...
  @Test
  public void shoulFetchInstrumentByAsOfDate() throws UnknownHostException {

    List<DBObject> instruments = indexDao.fetchAllInstrumentsForAsOfDate("2016-07-21");
    assertEquals(1, instruments.size());
    DBObject instrument = instruments.get(0);
    assertEquals("RBS", instrument.get("name"));
    assertEquals(100.5, instrument.get("floatingCapitalization"));
    assertEquals(100, instrument.get("fixedCapitalization"));
